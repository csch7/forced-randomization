...
The Manifest and Project files are already included in this repo. In order to compile the necessary packages, run "using Pkg; Pkg.instantiate()" in a Julia REPL. 

Afterwards, running include("main.jl") in a Julia REPL will output results described in section "An Example"
